...
const roundService = __importStar(require("../services/round.service"));
const createRound = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const adminId = req.user._id.toString();
        const result = yield roundService.createRound(req.params.gameId, adminId);
...
const startTurn = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield roundService.startTurn(req.params.roundId, userId);
        res.status(201).json(result);
    }
    catch (error) {
        res.status(400).json({ message: error.message });
...
const endTurn = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield roundService.endTurn(req.params.turnId);
        res.json(result);
    }
    catch (error) {
        res.status(400).json({ message: error.message });
